      ...
      <div id="formContainer">
        <div className="mb-5">
          ...
          <p className="text-gray-700">
            {t("intro")}{" "}
            <a
              href="mailto:ottawa@aemma.org"
              className="text-blue-600 underline hover:text-blue-400 hover:cursor-pointer transition duration-300 ease-in-out"
            >
              ottawa@aemma.org
            </a>
            .
            ...
            <div>
              ...
              <ul>
                <li className="text-gray-700">
                  ...
                  {chapters[activeIndex].address}
                </li>
                <li className="text-gray-700">
                  <strong>{chapters[activeIndex].place}</strong>
                </li>
                <li className="text-gray-700">
                  <strong>{t("email")}:</strong> {chapters[activeIndex].contact}
                </li>
              </ul>
            </div>
